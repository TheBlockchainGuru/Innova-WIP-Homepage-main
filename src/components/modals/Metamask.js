...
export default function Metamask ({open, handleClose}) {
            ...
            >
                ...
                >
                    ...
                    <Stack alignItems="center" gap={2} sx={{ maxWidth: 350 }}>
                        ...
                        <Typography variant="caption" sx={{ textAlign: 'center', maxWidth: 306, fontWeight: 400 }}>
                            Please connect your wallet so we verify you own this NFT so you can get access the deal.
                        </Typography>
                    </Stack>
